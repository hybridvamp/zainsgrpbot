...
class Development(Config):
    ...
    SQLALCHEMY_DATABASE_URI = 'postgresql://mbsjayagpjvepk:b154b95a66f2db7509892c463837cce657b40818f9b0ec29c9a23a6a93640aa5.@localhost:5432/dr3hs06mcn9g8'  # sample db credentials
